...
const diceValue5 = document.querySelector("#d5");
const diceValue6 = document.querySelector("#b1");
...
let rollAllDice = () => {
  ...
  diceValue2.innerHTML = roll();
  diceValue3.innerHTML = roll();
  diceValue4.innerHTML = roll();
  diceValue5.innerHTML = roll();
  diceValue6.innerHTML = roll();
